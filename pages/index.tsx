...
export const getStaticProps: GetStaticProps = async (ctx) => {
  ...
  const pokemons: Pokemon[] = data.results.map( ( poke, index ) => {
    ...
    return { ...poke, name: nameCapitalized, id: index + 1, img: `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${index + 387}.svg` }
  } )
